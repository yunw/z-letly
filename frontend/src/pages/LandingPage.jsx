...
const HEADER_HEIGHT = 64; // px, matches MUI default AppBar height

const LandingPage = () => {
  return (
    <>
      {/* Header with video background */}
      {/* <VideoBackground videoSrc="/videos/landing-bg.mp4" overlay={true}> */}
        <AppBar position="static" color="default" elevation={0} sx={{ background: 'transparent', boxShadow: 'none', height: `${HEADER_HEIGHT}px` }}>
          <Toolbar sx={{ minHeight: `${HEADER_HEIGHT}px`, display: 'flex', alignItems: 'center' }}>
